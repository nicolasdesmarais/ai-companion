...
export class WebUrlsApifyDataSourceAdapter
...
const webUrlsApifyDataSourceAdapter = new WebUrlsApifyDataSourceAdapter();
export default webUrlsApifyDataSourceAdapter;
