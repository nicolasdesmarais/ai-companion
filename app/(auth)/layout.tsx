      ...
      <div className="blue-bg flex flex-col h-screen md:h-full md:overflow-clip">
        ...
        <div className="flex justify-center h-full my-16">
          <div className="w-[500px] hidden md:block">
            ...
            <div>
              AppDirect AI is currently in a Closed Beta. If you have not
              received explicit instruction that you can access the product,
              please return to the homepage and sign up to be notified when we
              open up for more users.
            </div>
            <Image
