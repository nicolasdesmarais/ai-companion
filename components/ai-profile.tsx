...
export const AIProfile = ({ ai }: Props) => {
  ...
  return (
    <ResizePanel
      ...
      persist={false}
    >
      <div className="bg-profile px-6 space-y-4 w-full md:w-auto absolute left-0 md:left-[76px] right-0 top-[64px] md:top-0 bottom-0 lg:static overflow-auto pb-16">
